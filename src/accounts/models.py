...
class UserProfile(models.Model):
    ...
    twitter_link = models.CharField(max_length=320, null=True, blank=True, verbose_name='Twitter profile url')
...
def new_user_receiver(sender, instance, created, *args, **kwargs):
    if created:
        ...
        notify.send(
            instance, 
            recipient=MyUser.objects.get(username='hello7687667'), #admin user
